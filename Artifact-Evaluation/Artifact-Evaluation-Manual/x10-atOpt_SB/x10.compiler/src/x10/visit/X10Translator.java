...
/*Nobita code */
import  static x10.visit.X10PrettyPrinterVisitor.nextIteration;
/*Nobita code */
...
//                        targetDir.mkdirs();
            ...
            /* Nobita code */
            if (nextIteration && pathFile.equalsIgnoreCase(sfn.toString())) {
            	translateSource(sfn);
        	}
            
            if((chance <= 3) && pathFile.equalsIgnoreCase(sfn.toString())) {
        		chance++;
        		translateSource(sfn);
        	}
