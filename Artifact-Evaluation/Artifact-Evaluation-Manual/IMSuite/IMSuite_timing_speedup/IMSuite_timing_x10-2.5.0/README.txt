1) To run an X10-FA-2.5.0 and X10-FAC-2.5.0 kernel pre-installation of X10 is required. 
The following example depicts the compilation and execution of an X10-FA-2.5.0 and X10-FAC-2.5.0 kernel.
