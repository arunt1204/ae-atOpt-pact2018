...
/** 
 * inputGeneratorBFSBellman implements an input generator for the breadth 
 * first algorithm using the Bellman Ford approach. 
 ...
 */
public class inputGeneratorBFSBellman 
{
	/** 
	...
	public static void main(String []args) throws Exception {
		...
		boolean flag=false;
		String fileName = "inputbfsBellmanFord.txt";
		...
		if(choice == 0 || choice == 1) {
			output.write("" + size);				// Printing size
			output.write("\n" + r.nextInt(size) + "\n"); 	// Defining Root and printing it
			for(i=0; i<size; i++) {
				for(j=0; j<size; j++)
