...
/** 
 * inputGeneratorDominatingSet implements an input generator for generation
 ...
 */
public class inputGeneratorDominatingSet 
{
	/** 
	...
	public static void main(String []args) throws Exception {
		...
		boolean flag=false;
		String fileName = "inputdominatingSet.txt";
