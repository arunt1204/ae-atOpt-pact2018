...
/** 
 * inputGeneratorBFSDijkstra implements an input generator for the breadth 
 * first algorithm using the Dijkstra approach. 
 ...
 */
public class inputGeneratorBFSDijkstra 
{
	/** 
	...
	public static void main(String []args) throws Exception {
		...
		boolean flag=false;
		String fileName = "inputbfsDijkstra.txt";
